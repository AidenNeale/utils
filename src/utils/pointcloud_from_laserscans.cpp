...
namespace pcd_from_laserscan
{
    ...
    bool PointcloudFromLaserscan::pointcloudFromLaserscan()
    {
...
{
    pcd_from_laserscan::PointcloudFromLaserscan::Ptr pcd_from_ls = std::make_shared<pcd_from_laserscan::PointcloudFromLaserscan>();
